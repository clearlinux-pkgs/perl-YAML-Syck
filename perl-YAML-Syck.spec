...
Source0  : https://cpan.metacpan.org/authors/id/T/TO/TODDR/YAML-Syck-1.33.tar.gz
...
%prep
%setup -q -n YAML-Syck-1.33
cd %{_builddir}
tar xf %{_sourcedir}/libyaml-syck-perl_1.30-1.debian.tar.xz
cd %{_builddir}/YAML-Syck-1.33
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/YAML-Syck-1.33/deblicense/
...
cp %{_builddir}/YAML-Syck-1.33/COPYING %{buildroot}/usr/share/package-licenses/perl-YAML-Syck/3710975c0e6727079e17c6d1f27948c40729d710
